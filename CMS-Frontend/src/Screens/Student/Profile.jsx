...
import { 
  ...
  FiEdit, FiBookmark, FiCalendar, FiHash
} from "react-icons/fi";
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">View and manage your student account</p>
          </div>
                ...
                <div className="bg-white shadow rounded-lg overflow-hidden">
                  <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-6 flex flex-col items-center">
                    <div className="w-28 h-28 rounded-full overflow-hidden border-4 border-white shadow-lg mb-4">
                      <img
                        ...
                        onError={(e) => {
                          ...
                          e.target.src = "https://via.placeholder.com/112?text=Student";
                        }}
                      />
                    </div>
                    ...
                    <p className="text-blue-100 mt-1 text-center">
                      Semester {data.semester} • {data.branch}
                    </p>
                  </div>
                  ...
                  <div className="p-4 border-t border-gray-100">
                    <div className="flex items-center py-2">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-medium text-gray-800">{data.enrollmentNo}</p>
                      </div>
                    </div>
                    
                    <div className="flex items-center py-2">
                      <FiBookmark className="text-blue-500 mr-3" />
                      <div>
                        <p className="text-xs text-gray-500">Branch</p>
                        <p className="text-sm font-medium text-gray-800">{data.branch}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center py-2">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-medium text-gray-800">{data.semester}</p>
                      </div>
                    </div>
                  </div>
