...
import { FiSearch, FiUpload, FiX, FiUser, FiMail, FiPhone, FiUserPlus, FiBriefcase, FiBook } from "react-icons/fi";
      ...
      .then((response) => {
        ...
        if (response.data.success) {
          if (response.data.user.length !== 0) {
            ...
            toast.error("No Faculty Found With ID");
          }
        } else {
      ...
      <div className="max-w-4xl mx-auto animate-fadeIn">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Search for a faculty member by employee ID to update their information
          </p>
        </div>
        ...
        {search && id && (
          <div className="bg-white py-8 px-4 shadow-lg sm:rounded-lg sm:px-10 card animate-fadeIn">
            <form onSubmit={updateFacultyProfile} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="animate-slideIn delay-1100">
              ...
              <div className="flex justify-center mt-8 animate-slideIn delay-1200">
                <button
                  type="submit"
                  disabled={loading}
