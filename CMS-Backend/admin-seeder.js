...
const connectDB = async () => {
  try {
    ...
    if (!mongoURI) {
      ...
      console.error("   MONGODB_URI=mongodb://localhost:27017/campusflow");
      console.error("\n   OR for MongoDB Atlas:");
      console.error("   MONGODB_URI=mongodb+srv://username:password@cluster.mongodb.net/campusflow");
      console.error("\n💡 Make sure the .env file is in the correct location:");
      console.error("   project-root/.env (not in the seeders folder)\n");
      return false;
    }
